...
<table class = "box centerbox">
    ...
    <tr>
        <td>Filter</td>
        <td><a href="musicStore/sound/${productCode}/filter.mp3" class = "text-color h5">MP3</a></td>
    </tr>
    <tr>
        <td>So Long Lazy Ray</td>
        <td><a href="musicStore/sound/${productCode}/so_long.mp3" class = "text-color h5">MP3</a></td>
    </tr>
    </table>
