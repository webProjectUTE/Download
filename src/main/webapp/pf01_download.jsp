...
<table class = "box centerbox">
    ...
    <tr>
        <td>64 Corvair</td>
        <td><a href="musicStore/sound/${productCode}/corvair.mp3" class = "text-color h5">MP3</a></td>
    </tr>
    <tr>
        <td>Whiskey Before Breakfast</td>
        <td><a href="musicStore/sound/${productCode}/whiskey.mp3" class = "text-color h5">MP3</a></td>
    </tr>
    </table>
